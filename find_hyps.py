...
def objective(trial) -> None:
    ...
    config.dataset.val_size = trial.suggest_float("val_size", 0.1, 0.25, step=0.5)
...
def parse_arguments(argv):
    ...
    parser.add_argument("--cfg", type=str, default="/home/powned/projects/championat/Cryme2022/configs/baseline.yml", help="Path to config file.")
